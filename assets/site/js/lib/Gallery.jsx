    ...
    render(){
		...
		photoPreviewNodes.push(
			...
			<a href="#" className={k} onClick={(e) => this.props.onClickPhoto(k, e)}>
                <img src={src} srcSet={srcset} sizes={sizes} style={{display:'block', border:0, height:commonHeight, width: commonHeight * this.props.photos[k].aspectRatio}} height={commonHeight} width={commonHeight * this.props.photos[k].aspectRatio} alt={this.props.photos[k].alt} />
			</a>
		    </div>
		);
            }
