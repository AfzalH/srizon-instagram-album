...
function srizon_instagram_load_site_resources()
{
    ...
    wp_enqueue_script( 'react', srizon_instagram_get_resource_url( 'site/resources/react.min.js' ), null, '15' );
    wp_enqueue_script( 'react-dom', srizon_instagram_get_resource_url( 'site/resources/react-dom.min.js' ), null, '15' );
